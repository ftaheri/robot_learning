...
2.2
Updating and publishing map msg
implementing at:
...
double cell_x =
x * map_resolution_ + map_msg_.info.origin.position.x;
...
could capture the uncertainty and assumes a cell to be occupied if laser range is in the √
cell. I also could
have used the maximum distance of the cell’s point to the laser range point by using 2 ∗ resolution.
